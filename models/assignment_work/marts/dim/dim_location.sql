...
WITH all_locations AS (
   ...
   SELECT DISTINCT
      location_key --TODO replace (HINT: look @ dimensional model & staging data!)
...
SELECT location_key FROM location_dimension --TODO replace ??s with what to select. HINT: May be quite simple!